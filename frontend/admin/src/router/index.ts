...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'ai/intent-test', name: 'ai-intent-test', component: () => import('@/views/ai/IntentTestPage.vue'), meta: { title: '意图路由测试', group: 'ai' } },
      { path: 'ai/cache-test', name: 'ai-cache-test', component: () => import('@/views/ai/CacheTestPage.vue'), meta: { title: '语义缓存测试', group: 'ai' } },
      { path: 'knowledge/kg-test', name: 'kg-test', component: () => import('@/views/knowledge/KgTestPage.vue'), meta: { title: '图谱检索测试', group: 'knowledge' } },
